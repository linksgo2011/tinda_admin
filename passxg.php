...
<div style="background: #cfcfcf;height:40px;line-height:40px;text-align:center;"><span
            ...
            style="font-size:16px;margin-left:-12%;">修改密码</b></div>
...
<form onSubmit="return indexLogin1();" method="POST">
    ...
    <ul class="onlin-text">
        <p>&nbsp;</p>
        <li><b class="red1">&nbsp;新&nbsp;密&nbsp;码</b><input name="l_pass" type="password" class="online-input"
                                                            id="l_pass" value="" placeholder="请输入6位以上的字符"></li>
        <li><b class="red1">确认密码</b><input name="l_pass1" type="password" class="online-input" id="l_pass1" value=""
