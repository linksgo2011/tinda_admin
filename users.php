...
<div style="background: #cfcfcf;height:40px;line-height:40px;text-align:center;"><span style="float: left;margin-left:10px;"><a href="javascript:history.back(-1)"><i class="am-icon-reply"></i>返回</a></span><b style="font-size:16px;">个人信息</b><span style="float: right;margin-right:10px;"><a href="?exid=exit">注销<i class="am-icon-mail-forward"></i></a></div>
