...
<?php
	...
	$xg_id=$_POST["xg_id"];
	$logoA=$_POST["img"];
		$sql1="update finl set logoA='$logoA' where id=$xg_id";
		if (mysql_query($sql1))
		{
		echo "<script language=javascript>alert('上传成功！');window.location='chaxfinl.php'</script>";
		}
		die();
	}
...
<div class="formbody" style="background:#ddd">
    <div id="usual1" class="usual"> 
  	...
  	<div class="tabson">
<form id="form1" name="form1" action="sanqlogo.php" method="post">
    ...
    <li>
      <label>标志</label>
      <input name="img"type="text" class="dfinput" id="url1" value="<?php echo $rows["logoA"]?>" readonly="readonly" /> 
